...
int main(){
    ...
    while (!glfwWindowShouldClose(window))     {
        ...
        if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) RC.up();
        if (glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS) RC.right();
        if (glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS) RC.down();
        if (glfwGetKey(window, GLFW_KEY_F) == GLFW_PRESS) RC.front();
        if (glfwGetKey(window, GLFW_KEY_B) == GLFW_PRESS) RC.back();
